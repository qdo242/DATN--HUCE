...
uint32_t seq;
uint32_t cycles = 0;
float lat = 21.84470, lon = 104.09700;
...
void setup() {
  ...
  delay(1000);
  Serial.println("\n==========================================");
  Serial.println(" XI_01 - IoT DATN Simulation");
...
void loop() {
  ...
  // ===== PHASE 1: BEACON =====
  Serial.printf("\n--- LAN %d: %s ---\n", cycles + 1, XI_ID);
  hien_thi("Xi_01: Phat Beacon", "B|Xi_01", "", "Cho ACK...");
  ...
  delay(1000);
  hien_thi("Xi_01: Nhan ACK", "Tu Y_01", "", "Dang doc sensor...");
  ...
  hien_thi("Xi_01: Doc cam bien", buf, buf2, buf3);
  ...
  hien_thi("Xi_01: AES xong", "Gui data...", "", "");

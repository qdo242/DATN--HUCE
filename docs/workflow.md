...
```
Xi node 1 (Xi_01: TTGO T-Beam + BME280 + GPS + OLED)
Xi node 2 (Xi_02: TTGO T-Beam + BME280 + GPS + OLED)
  │
  │  [1] Phát Beacon "B|<Xi_ID>" (LoRa)
  │  [2] Chờ ACK từ Y
  │  [3] Đọc cảm biến (BME280, GPS)
...
Dashboard (Streamlit + Leaflet/OpenStreetMap)
  │  [1] Biểu đồ cảm biến (nhiệt độ, độ ẩm, áp suất, CO2, CO, NH3)
...
- [x] Firmware Xi node: T-Beam đọc BME280, GPS, mã hóa AES, gửi LoRa

...
## 🏗️ PHẦN 1: TẠ HUY HOÀNG (Nội dung công việc 1)
...
- 1.2. Lựa chọn thuật toán mã hóa đối xứng AES-128-GCM.
- 1.3. Thiết kế cấu trúc gói tin bảo mật đa lớp (Encrypted Data + HMAC).
